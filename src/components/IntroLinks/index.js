...
const IntroLinks = () => {
    return (
        <div>
            ...
            <p className="links">
                I have one spot open in October. <a href="https://www.linkedin.com/in/andi-weis/" aria-label="Connect with me on LinkedIn">Connect on LinkedIn</a> or <a href="mailto:post@andreasweis.com?subject=👋" aria-label="Write me an email">drop me an email</a>.
            </p>
        </div>
    )
